...
const Header = () => {
  return (
    <header className="z-1 flex items-center justify-between max-sm:px-10 max-sm:py-5 sm:px-30 sm:py-8 bg-white">
      <Blob1 cssClass="max-sm:w-115 absolute w-140 -top-85 -left-17 -rotate-170 z-2"></Blob1>
      <div className=" z-3">
        <h3 className="text-white max-sm:text-2xl sm:text-3xl font-bold">BtoGo</h3>
      </div>
